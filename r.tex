...
\begin{frame}\tt
(Not so much) horrific finite difference scheme {\rm \textnumero} 3\\
====================================================\\
$ $\\
{\rm\tiny\color{gray}
...
\only<1>{\includegraphics[height=0.7\textheight]{fb/woolwich_before.png}}%
\only<2>{\includegraphics[height=0.7\textheight]{fb/woolwich_after.png}}%
\end{frame}
...
\only<1>{\includegraphics[height=0.7\textheight]{fb/wool1_before.png}}%
\only<2>{\includegraphics[height=0.7\textheight]{fb/wool1_after.png}}%
\end{frame}
...
\only<1>{\includegraphics[height=0.7\textheight]{fb/hill_before.png}}%
\only<2>{\includegraphics[height=0.7\textheight]{fb/hill_after.png}}%
\end{frame}
